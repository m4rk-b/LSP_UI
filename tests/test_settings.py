...
class HomeTest(BaseCase):
    ...
    def test_contact_master(self, test_text="TESTNAME"):
        ...
        self.utils.input_text(settings_card_title, "name", "settings",  test_text)
        ...
        self.utils.input_text(settings_card_title, "name", "settings", modified_text)
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
    ...
    def test_default_einvoice_type(self, input_text=None):
        ...
        self.utils.find_button_and_click("MODIFY")
        self.utils.input_text(settings_card_title, "einvoice_type", "settings")
        self.utils.find_button_and_click("Save")
    ...
    def test_export_invoices_customs_information(self):
        ...
        # For combobox input
        button_click = "Save"
        combobox_value = self.utils.input_text(settings_card_title, "invoice_id", "settings")
        if combobox_value == "":
            button_click = "Cancel"
        ...
        if combobox_value != "":
            ...
            self.utils.find_button_and_click("Modify")
            self.utils.switch_to_main_frame()
            shipping_port_code = self.utils.input_text(settings_card_title, "shipping_port_code", "settings")
    ...
    def test_industry_maintenance(self, test_text="TESTIND"):
        ...
        self.utils.find_button_and_click("Add")
        self.utils.input_text(settings_card_title, "identifier", "settings")
        self.utils.input_text(settings_card_title, "type", "settings")
        self.utils.input_text(settings_card_title, "industry", "settings")
        ...
        self.utils.find_button_and_click("Modify")
        self.utils.input_text(settings_card_title, "identifier", "settings", f"MOD{test_text}")
        # self.utils.click_button("SaveButton")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
    ...
    def test_invoice_translation_maintenance(self, test_text="TESTTAX"):
        ...
        # self.utils.click_button("AddButton")
        self.utils.find_button_and_click("Add")
        tax_code = self.utils.input_text(settings_card_title, "user_tax_code", "settings")
        # self.utils.message_box("YES")
        self.utils.input_text(settings_card_title, "standard_tax_code", "settings")
        ...
        description = self.utils.input_text(settings_card_title, "standard_code_description", "settings")
        # self.utils.click_button("SaveButton")
        self.utils.find_button_and_click("save")
        self.utils.message_box("OK")
    ...
    def test_supplementary_data_setup(self):
        ...
        # ADD
        self.utils.find_button_and_click("Add")
        sd_name = self.utils.input_text(settings_card_title, "supplementary_data_name", "settings")
        self.utils.input_text(settings_card_title, "version", "settings")
        ...
        user_defined = self.utils.input_text(settings_card_title, "user_define_field", "settings")
        self.utils.click_button("SaveButton")
        ...
        mod_user_defined = self.utils.input_text(settings_card_title, "user_define_field", "settings", f"MOD{user_defined}")
        self.utils.message_box("YES")
        self.utils.find_button_and_click("Save")
        ...
        self.utils.table(sd_name, "AddendaGrid")
        self.utils.find_button_and_click("Modify")
        mod_sd_name = self.utils.input_text(settings_card_title, "supplementary_data_name", "settings", f"MOD{sd_name}")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
    ...
    def test_supplementary_data_old(self):
        ...
        # ADD
        self.utils.find_button_and_click("Add")
        customer_id = self.utils.input_text(f"{settings_card_title}_old", "customer_id", "settings")
        self.utils.input_text(f"{settings_card_title}_old", "supplementary_data_name_and_version", "settings")
        self.utils.find_button_and_click("Save")
    ...
    def test_non_stock_maintenance(self):
        ...
        # self.utils.click_button("AddButton")
        self.utils.find_button_and_click("Add")
        item_id = self.utils.input_text(settings_card_title, "item_id", "settings")
        # self.utils.click_button("SaveButton")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
        ...
        # self.utils.click_button("ModifyButton")
        self.utils.find_button_and_click("Modify")
        item_description = self.utils.input_text(settings_card_title, "item_description", "settings")
        # self.utils.click_button("SaveButton")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
    ...
    def test_ar_default_language_code(self):
        ...
        # self.utils.click_button("ModifyButton")
        self.utils.find_button_and_click("Modify")
        self.utils.input_text(settings_card_name, "language_code", "settings")
        # self.utils.click_button("SaveButton")
        self.utils.find_button_and_click("Save")
    ...
    def test_einvoice_type_translation(self):
        ...
        # self.utils.click_button("AddButton")
        self.utils.find_button_and_click("Add")
        user_einvoice_type = self.utils.input_text(settings_card_name, "user_einvoice_type", "settings")
        standard_einvoice_type = self.utils.input_text(settings_card_name, "standard_einvoice_type", "settings")
        # self.utils.click_button("SaveButton")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
        ...
        # self.utils.click_button("ModifyButton")
        self.utils.find_button_and_click("Modify")
        user_einvoice_type_description = self.utils.input_text(settings_card_name, "user_einvoice_type_description", "settings", f"MOD{user_einvoice_type}")
        # self.utils.click_button("SaveButton")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
    ...
    def test_customer_einvoice_maintenance(self):
        ...
        # self.utils.click_button("AddButton")
        self.utils.find_button_and_click("Add")
        party_id = self.utils.input_text(settings_card_name, "party_id", "settings")
        self.utils.input_text(settings_card_name, "einvoice_type", "settings")
        # self.utils.click_button("SaveButton")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
    ...
    def test_customer_long_name(self):
        ...
        #ADD
        self.utils.find_button_and_click("Add")
        customer_id = self.utils.input_text(settings_card_name, "customer_id", "settings")
        self.utils.input_text(settings_card_name, "customer_long_name", "settings")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
        ...
        self.utils.find_button_and_click("Modify")
        description_modified = self.utils.input_text(settings_card_name, "customer_long_name", "settings", "Modified")
        # self.utils.find_button_and_click("Save")
        # self.utils.message_box("Yes")
        self.utils.find_button_and_click("Save")
        self.utils.message_box("OK")
